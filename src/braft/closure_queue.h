...
class ClosureQueue {
   public:
    ...
    // of their indexes, |out_first_index| would be assigned the index of out[0]
    // if out is not empty, index + 1 otherwise.
    int pop_closure_until(int64_t index, std::vector<Closure*>* out,
